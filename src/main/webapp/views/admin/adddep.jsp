...
<body>
	...
	<div id="login">
	<form action="adddepaction" method="post" modelAttribute="dep">
			<h1>
				<strong>Welcome.</strong> Add HOD.
			</h1>
			<fieldset>
			<p>
					<input type="text" name="fullname" id="fullname" placeholder="Department Full Name">
				</p>
				
				<p>
					<input type="text" name="name" id="name" placeholder="Short Name">
				</p>
				<p>
					<input type="submit" onclick="javascript: return confirm('Are you sure you want to Add this Department?');" value="Add">
				</p>
			</fieldset>
		</form>
		</div>
		...
		<table class="table table-striped" style="text-align: center;">
			...
			<jstlc:forEach var="dep" items="${dep_list}">
				<tr>
					...
					<td>${dep.name}</td>
					<td>
						<a href="${pageContext.request.contextPath}/admin/adddep/edit?id=${dep.id}">Edit</a> | 
						<a href="${pageContext.request.contextPath}/admin/adddep/delete?id=${dep.id}" 
