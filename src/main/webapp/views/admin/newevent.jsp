...
<body>
	...
	<div id="login">
		<form action="addevent" method="post">
			<h1>
				<strong>Welcome Admin .</strong> Add EVENT.
			</h1>
			<fieldset>
				<p>
				...
				<p>
					<select name="type" id="type">
						...
						<jstlc:forEach var="dep" items="${dep}">
			...
			<jstlc:forEach var="event" items="${newevents}">
				<tr>
					...
					<td><a style="text-transform: capitalize;"
						href="${pageContext.request.contextPath}/admin/eventaccess?id=${event.id}"
						onclick="javascript: return confirm('Are you sure you want to Remove Access?');">Give
							Access</a>| <a style="text-transform: capitalize;"
						href="${pageContext.request.contextPath}/admin/eventdelete?id=${event.id}"
		...
		<table class="table table-striped" id="student-list-table"
			...
			<jstlc:forEach var="event" items="${events}">
				<tr>
					...
					<td><a style="text-transform: capitalize;"
						href="${pageContext.request.contextPath}/admin/eventaccess?id=${event.id}"
						onclick="javascript: return confirm('Are you sure you want to Remove Access?');">Remove
							Access</a>| <a style="text-transform: capitalize;"
						href="${pageContext.request.contextPath}/admin/eventstatus?id=${event.id}"
						onclick="javascript: return confirm('Are you sure you want to Make CR to this Student?');">
						...
						onclick="javascript: return confirm('Are you sure you want to Make CR to this Student?');">
							Delete</a></td>
							<td><a style="text-transform: capitalize;"
						href="${pageContext.request.contextPath}/admin/eventview?id=${event.id}"
						onclick="javascript: return confirm('Are you sure you want to Remove Access?');">
							View</a></td>
				</tr>
			</jstlc:forEach>
		</table>
